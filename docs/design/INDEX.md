...
10b. **P1 목업 시각 레이어 (진행 중 — wiring gate #10과 분리)** — DoD: `P1_VISUAL_DOD.md` · DOM ~65% / mockup 1:1 ~45% (2026-05-31 갭 재검증) · C01 `foms_app_shell.html` · 홈 §6.2 (chip-strip 제거, 작업 큐 full-page, compact card, filter bottom sheet, workflow-stage action, thumb, mobile_chunk) · tablet split master · 상세 KV 4섹션+C07 lightbox · wizard C14+attachments · §6.3 도면/§6.5 AS camera bar · `test_p1_mockup_*` + staging smoke
