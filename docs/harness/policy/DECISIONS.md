...
- **영향**: `tools/harness/{session_worktree,session_commit_ledger,deploy_push_scope}.py`, `run.py`, `migrations/env.py`, `tests/harness/test_session_worktree.py`, `AGENTS.md`/`CLAUDE.md`/`.cursor/rules/00-project-context.mdc`, `docs/plans/2026-07-27-session-worktree-isolation-phase1.md`.
