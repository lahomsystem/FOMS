...
| `docs/harness/policy/DECISIONS.md` | 추적 정책 결정 기록 |
| `docs/ARCHIVE_INDEX.md` | spec 인덱싱 |
| `temp_script.js` | 저장소에서 제거 |
| `test_scripts.js` | 저장소에서 제거 |
| `test.html` | 저장소에서 제거 |
| `docs/harness/logs/HOOK_RAW_DUMP.txt` | git 추적 해제 |
| `docs/harness/logs/.hook_raw_once` | git 추적 해제 |
...
- [x] `docs/harness/logs/HOOK_RAW_DUMP.txt`, `docs/harness/logs/.hook_raw_once`가 ignore 정책 아래로 내려감
- [x] `docs/AI_STATUS.md`, `docs/harness/runtime/SESSION_LOG.md`, `docs/harness/runtime/EDIT_LOG.md`, `docs/harness/runtime/COMPACT_CHECKPOINT.md`는 유지됨
