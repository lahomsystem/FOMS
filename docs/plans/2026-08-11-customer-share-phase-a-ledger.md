...
| T2 | 비로그인 열람 `GET /s/<token>` (drawing) | `pytest tests/domains/test_order_share_view.py -q` PASS(격리·410·fail-closed 503 표면·헤더·FILE_VIEW 1행) + APP_OK | DONE | (커밋 직후 기입) | 12 passed + namespace 게이트 358 passed. presign 전멸=503, onerror 새로고침 안내 |
