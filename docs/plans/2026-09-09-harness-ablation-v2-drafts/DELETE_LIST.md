...
**origin SHA 대응** (위 표의 로컬 커밋은 origin/deploy 에 cherry-pick 재적용본으로 올라갔다 — 로컬 → origin, origin 순서. 범위 `075438c3b`~`5e9286a52` 12커밋, `ci_watch --quick 5e9286a52 deploy` ALL GREEN exit 0):

| 로컬 | origin/deploy | 내용 |
|---|---|---|
| `168828c81` | `075438c3b` | 1단계 문서 5묶음 |
| `7eecbb4d2` | `cf10446cb` | §1 사실 오류 정정 |
| `08279d7da` | `aca569138` | §3 규칙 파일 교체 |
| `af5ba2743` | `30ad4716c` | §4 프로젝트 훅 |
| `f758490b7` | `ced0afd69` | §5 가드 인프라 5종 |
| `8451b64cc` | `7cb4790a8` | §6 MOVE-TO-CODE |
| `87773fe95` | `4021ac88a` | §7 메모리 |
| `5828c02b0` | `391f4944a` | 3단계 부산물·Opus 5 재실험 |
| `9c44d7653` | `6e926ffa4` | §2 플러그인 |
| `6a844de71` | `4191d5b91` | 마감 문서 |
| (없음) | `068ae3e91` | 재적용 정정 — ctx_gate 삭제 철회(타 세션 근본 수정본 유지) + 중복 경로 테스트 제거 |
| (없음) | `5e9286a52` | 가드 구멍 봉합 — 임시 worktree 면제를 명시 경로(-C·선행 cd)로만 |
