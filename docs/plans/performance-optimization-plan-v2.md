...
- [x] Railway staging 또는 동등 환경에서 주요 페이지 smoke test

### 실측

- [x] 날짜 필터 없음 / 단일 날짜 / 범위 날짜 결과 건수 비교
- [x] 패널 수치와 테이블 목록의 의미 일치 확인

### 출고

- [x] 범위 / 단일 날짜 / 전체 기간 분기별 결과 건수 비교
- [x] AS 포함 로직과 담당자 필터 유지 확인

### 지도

- [x] 좌표 없는 주문 포함 상태에서도 첫 응답이 빠르게 끝나는지 확인
- [x] 비동기 좌표 채움 후 지도 갱신 확인

### 첨부

- [x] ERP / 생산 / 시공 대시보드 첨부 개수 일치 확인
