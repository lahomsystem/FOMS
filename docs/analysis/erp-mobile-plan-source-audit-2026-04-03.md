...
- 기준 문서:
  - `docs/analysis/erp-mobile-implementation-plan-2026-04-01.md`
  - `docs/analysis/erp-mobile-plan-source-audit-2026-04-02.md`
...
- 아티팩트:
  - `docs/analysis/browser_audit_2026-04-03_menu_shipment_fix/results.json`
  - `docs/analysis/browser_audit_2026-04-03_menu_shipment_fix/screenshots/`
- 판정:
  - phone `/erp/dashboard`
