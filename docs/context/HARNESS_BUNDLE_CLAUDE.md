...
- **Output**: `docs/context/HARNESS_BUNDLE_CLAUDE.md`
...
Web exploration and manual QA use Cursor browser MCP; repeatability via gstack browse remains a future integration per master plan.
...
- **claude_code**: CLAUDE.md augments AGENTS.md; where CLAUDE.md mentions bash/Unix examples, treat them as Claude Code session-only unless repo docs say otherwise.
