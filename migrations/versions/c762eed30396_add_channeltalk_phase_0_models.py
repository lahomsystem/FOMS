...
def upgrade() -> None:
    ...
    # ============================================
    has_channel_source_seq = 'channel_source_seq' in [c['name'] for c in inspector.get_columns('orders')]
    if not has_channel_source_seq:
    ...
    # ============================================
    if 'channel_delivery_logs' not in tables:
    ...
    if 'channel_inbound_event_logs' not in tables:
    ...
    if 'channel_manager_links' not in tables:
