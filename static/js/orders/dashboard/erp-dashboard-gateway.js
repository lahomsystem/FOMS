function drawingActionLabel(action) {
        ...
        var __drawingGatewayImageGroups = {};
        var __drawingGatewayViewerFiles = [];
        var __drawingGatewayViewerIndex = 0;
        var __drawingGatewayViewerScale = 1;
        var __drawingGatewayViewerPanX = 0;
        var __drawingGatewayViewerPanY = 0;
        var __drawingGatewayViewerDragging = false;
        var __drawingGatewayViewerStartX = 0;
        var __drawingGatewayViewerStartY = 0;
        var __drawingGatewayViewerStartPanX = 0;
