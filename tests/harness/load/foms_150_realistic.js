...
const TRACE_SUMMARY_JSON = __ENV.TRACE_SUMMARY_JSON || 'tests/harness/load/last_trace_summary.json';
const TRACE_SUMMARY_TXT = __ENV.TRACE_SUMMARY_TXT || 'tests/harness/load/last_trace_summary.txt';
...
if (SESSION_POOL.length === 0) {
  throw new Error(
    'No session cookies found. Set SESSION_COOKIE or SESSION_COOKIES, or create tests/harness/load/session_cookies.txt',
  );
}
