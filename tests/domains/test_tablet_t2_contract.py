...
def test_mobile_surfaces_parent_cachebuster_bumped() -> None:
    ...
    assert "foms-mobile-surfaces.css') }}?v=20260715d" in layout_head
...
def test_calc_skin_wired_in_calculator_template_with_cachebuster() -> None:
    ...
    m = re.search(r"tablet-skin\.css'\s*\)\s*}}\?v=20260715b", html)
    assert m is not None, "calculator.html 에 tablet-skin.css ?v=20260715b <link> 부재"
