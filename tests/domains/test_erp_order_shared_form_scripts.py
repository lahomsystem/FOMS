...
def _assert_shared_form_script_contract(body: str) -> None:
    ...
    assert "js/orders/erp-order-shared.js?v=20260723a" in body
...
def test_mobile_attachment_preview_uses_viewport_sized_modal() -> None:
    ...
    assert "../components/foms-form-field.css?v=20260723b" in mobile_bundle
    assert "foms-mobile-surfaces.css') }}?v=20260723b" in layout_head
