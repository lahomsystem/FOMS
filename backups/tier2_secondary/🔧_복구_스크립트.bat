...
echo 데이터베이스 백업 파일: database_backup_20251204_142525.sql
echo.
pause
...
REM 백업 데이터 복원
psql -U postgres -h localhost -d furniture_orders -f "backups/tier2_secondary\database_backup_20251204_142525.sql"
