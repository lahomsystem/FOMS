"""대시보드 Blueprint (canonical; SFC-B11B).
...
from foms.web.erp import apply_erp_display_fields_to_orders
...
def regional_dashboard():
    ...
    return render_template('measurement/regional_dashboard.html',
...
def metropolitan_dashboard():
    ...
    return render_template('measurement/metropolitan_dashboard.html',
...
def self_measurement_dashboard():
    ...
    return render_template('measurement/self_measurement_dashboard.html',
        pending_orders=pending_orders,
        scheduled_orders=scheduled_orders,
        as_orders=as_orders,
        completed_orders=completed_orders,
