"""Chat JSON API route registration (Quest 3~10). HTML pages: ``foms.web.channel.routes``."""

from foms.services.storage import get_storage

from foms.api.channel.blueprint import chat_bp
from foms.api.channel.files import (  # noqa: F401
    api_chat_download,
    api_chat_preview,
    api_chat_upload,
...
from foms.api.channel.messages import (  # noqa: F401
...
from foms.api.channel.rooms import (  # noqa: F401
