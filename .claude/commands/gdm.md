...
1. **근본 해결 원칙**: 임시적인 방법(우회 등) 절대 금지, **무조건 근본적인 해결(클린코드 원칙 입각)**
2. **단순화 우선**: "고칠 수 있나?" 보다 **"없앨 수 있나?"**
3. **구조적 의심**: 반복 버그 → 패턴 자체가 문제
4. **시간 차원 인지**: "지금 보인다" ≠ "아까도 있었다"
5. **오컴의 면도날**: 단계가 적은 쪽이 정답
