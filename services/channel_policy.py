...
def _build_order_detail_link(order_id: Any) -> str:
    ...
    try:
        ...
        token = generate_wam_launch_token("wam_viewer", int(order_id))
        return f"{erp_url}/channel/wam/?launch_token={token}"
    except Exception:
        return fallback
...
def resolve_inbound_policy(group_id: str, template_key: str, create_enabled: bool) -> Dict[str, Any]:
    """CT-5.11: inbound webhook policy."""
