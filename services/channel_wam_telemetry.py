...
from services.channel_wam_view_models import WamRequestContext
...
def record_wam_telemetry(context: WamRequestContext, event_name: str, payload: dict[str, Any] | None = None) -> bool:
